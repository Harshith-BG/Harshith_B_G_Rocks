...
class MiniChess:
    ...
    def choose_turn(self):
        global sheet
        while True:
            self.invert_or = input('''ENTER 1 to get first turn 
ENTER 2 to play second
ENTER 3 to Reset LEARNER progress !!!
ENTER 4 to play against MASTER
Enter your choice :''')
...
if __name__ == "__main__":
    print("\nLearner : Learns from each defeat and comes back stronger")
    print("Master : Learner who has gone through all trials\nYou play against Learner by Default\n")
    main()
    wb.save('BOOK.xlsx')